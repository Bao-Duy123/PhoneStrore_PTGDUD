...
const Cart = ({ cartItems, onUpdateQuantity, onRemoveItem, onCheckout, onBuyNow }) => {
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="bg-white p-4 rounded-xl flex items-center justify-between shadow-sm border border-gray-100">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <span className="font-bold text-gray-800 text-sm">Chọn tất cả ({cartItems.length})</span>
              </label>
          ...
          <div className="w-full lg:w-[350px]">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-4 sticky top-24">
              ...
              <Button 
                onClick={onCheckout} 
                variant="danger" 
                className="w-full !bg-[#d00000] hover:!bg-[#b00000] !py-3.5 text-base font-bold rounded-lg shadow-[0_4px_10px_rgba(208,0,0,0.3)] transition-all"
              >
                Thanh toán
              </Button>
            </div>
