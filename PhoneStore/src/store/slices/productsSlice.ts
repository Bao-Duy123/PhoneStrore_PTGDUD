...
// Default products nếu chưa có data trong storage
...
function filterAndPaginate(products: Product[], filters: ProductFilters, page: number, pageSize: number): PaginatedResponse<Product> {
