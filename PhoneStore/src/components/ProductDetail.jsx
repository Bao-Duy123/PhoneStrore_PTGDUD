...
const ProductDetail = ({ product, onBack, onBuyNow, onAddToCart }) => {
  const p = product || {
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button 
              ...
              className="flex-1 flex items-center justify-center gap-2 px-6 py-3.5 border-2 border-[#d00000] text-[#d00000] bg-white rounded-lg hover:bg-red-50 font-bold transition-all text-lg shadow-sm"
            >
