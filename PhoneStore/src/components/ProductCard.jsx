    ...
    >
      ...
      <div className="w-full aspect-[4/5] bg-gray-50 rounded-lg mb-4 flex items-center justify-center p-2 mt-4 overflow-hidden">
        <img 
          ...
          onError={(e) => {
            e.target.src = "https://cdn2.cellphones.com.vn/insecure/rs:fill:300:300/q:100/plain/https://cellphones.com.vn/media/catalog/product/i/p/iphone-17-pro-256-gb.png";
          }}
        />
      </div>
